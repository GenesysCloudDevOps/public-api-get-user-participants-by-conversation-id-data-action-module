A Terraform/CX as Code remote module for the following Genesys Cloud public API operation: Get User Participants by Conversation ID
...
```hcl
module "data_action" {
    source             = "git::https://github.com/GenesysCloudDevOps/public-api-get-user-participants-by-conversation-id-data-action-module.git?ref=v1.0.0"
    action_name        = "Get User Participants by Conversation ID"
